...
int main() {
    const int MAX = 32768;
    const int SKIP1 = 0;
    const int SKIP2 = 8192;
    const int SKIP3 = 16384;
    const int SKIP4 = 24576;
...
#pragma clang loop interleave(disable)
    ...
    global_array[SKIP1] = SKIP2;
    global_array[SKIP2] = SKIP3;
    global_array[SKIP3] = SKIP4;
    global_array[SKIP4] = SKIP1;
